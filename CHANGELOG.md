...
- Add graceful shutdown ([#351](https://github.com/danroc/geoblock/pull/351))

### Fixed

- Fix time.Tick leak ([#351](https://github.com/danroc/geoblock/pull/351))
- Fix version format to match git describe output ([#342](https://github.com/danroc/geoblock/pull/342))

### Changed

- Migrate to golangci-lint v2 ([#343](https://github.com/danroc/geoblock/pull/343), [#345](https://github.com/danroc/geoblock/pull/345))
- Extend Docker workflow to publish develop images ([#339](https://github.com/danroc/geoblock/pull/339))

## [0.5.0] - 2025-12-19

### Changed

- **BREAKING:** Rename `GEOBLOCK_CONFIG` environment variable to `GEOBLOCK_CONFIG_FILE` ([#308](https://github.com/danroc/geoblock/pull/308))

## [0.4.1] - 2025-12-18

### Added

- Support multiple IPs in X-Forwarded-For header ([#305](https://github.com/danroc/geoblock/pull/305))
